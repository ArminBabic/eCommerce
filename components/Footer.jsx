  ...
  return (
    <div className="bg-[#191919] flex flex-col mx-auto items-center text-white gap-4  mt-40 px-6">
      <div className="flex flex-col md:flex-row gap-2 lg:gap-20 items-center md:max-h-[350px] ">
        <div className=" ">
          <div className="w-[240px] h-[270px] xs:w-[300px] xs:h-[330px] sm:w-[360px] sm:h-[440px] relative bottom-[3rem] sm:bottom-[2.7rem] md:bottom-[1.8rem]">
            <Image src={footerImg} layout="fill" alt="footerImg" />
          </div>
        </div>
        <div className="w-full sm:max-w-[450px] md:max-w-[500px] px-4 flex flex-col gap-6">
          <h2 className="text-white  text-2xl xs:text-3xl lg:text-4xl font-bold px-2 xs:px-3">
            Being first has its perks
          </h2>
          <p className="w-full max-w-[370px] text-sm xs:text-base px-2 xs:px-3">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-2">
            ...
            />
            <butoon className=" font-md text-center font-semibold text-[#191919] bg-white border-white border-2 rounded-[3rem] px-[4.5rem] sm:px-10 md:px-4 lg:px-12 py-3 uppercase hover:text-white hover:bg-[#191919] ease-in duration-300 cursor-pointer">
              Sign Up
            </butoon>
          </div>
        </div>
