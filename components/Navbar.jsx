    ...
    >
          ...
          <div className="logo">
            <Link href="/">
              <div
                className={
                  !scrollNav
                    ? "text-3xl text-gray-400 lg:text-[#191919] font-bold italic cursor-pointer"
        ...
        <div className="lg:hidden mr-4 " onClick={navHandler}>
          {!nav ? (
            <GiHamburgerMenu
              className={
                !scrollNav
                  ? "w-8 h-8 text-gray-400 lg:text-gray-400 cursor-pointer hover:text-gray-700  ease-in duration-300"
                  : "w-8 h-8 text-[#191919] lg:text-gray-400 cursor-pointer hover:text-gray-700 ease-in duration-300"
              }
            />
          ) : (
      ...
      >
        <ul className="pt-20 text-center space-y-6 md:space-y-4 text-gray-600">
          <li
            onClick={navHandler}
            className="font-openSans font-bold text-base xs:text-xl  xs:p-1 sm:p-4 tracking-[1px]  nav"
          >
            <Link href="/">Home</Link>
          </li>
          ...
          <li
            onClick={navHandler}
            className="font-openSans text-base xs:text-xl font-bold  sm:text-lg xs:p-1 sm:p-4 tracking-[1px]  nav"
          >
            <Link href={"/products/headphones"}>Headphones</Link>
          </li>
          <li
